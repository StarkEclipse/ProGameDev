...
def gameover():
    if p1hp <= 0:
        screen.fill("#000000")
        gameovertext = hpfont.render(f"Player two wins\nRemaining health is: {p2hp}", 1, "white")
        screen.blit(gameovertext, center = (900/2, 500/2))
    if p2hp <= 0:
        screen.fill("#000000")
        gameovertext = hpfont.render(f"Player one wins\nRemaining health is {p1hp}", 1, "white")
        screen.blit(gameovertext, center = (900/2, 500/2))
